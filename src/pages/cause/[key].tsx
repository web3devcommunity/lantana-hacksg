    ...
    return (
        <SocialLayout>
            <main>
                ...
                <Typography variant='h4' color="text.secondary">organized by {cause.organizer.title}</Typography>
                ...
                <Grid container sx={{ marginTop: '50px' }}>
                    ...
                    <Grid item xs={12} md={6}>
                        <div>
                            Funding Received: $123,456
                        </div>
                        <CauseAttestationList causeAttestations={TEST_CAUSE_ATTESTATION_RAW} />
                    </Grid>
                </Grid>
